...
class ApiExceptionRegistry
{
    ...
    public static array $handlers = [
        ...
        RatingException::class => 'handleRatingException',
    ];
    ...
    public static function handleRatingException(RatingException $e, Request $request): JsonResponse
    {
        self::logException($e, $request, 'warning');

        return self::jsonResponse($e, Response::HTTP_CONFLICT, $e->getMessage());
    }
